function [mask,R2,G2,B2,centersX,centersY,types] = test_DL1_yiq(R,G,B,origR,origC,doResize,wsize)
...
%     B2 = preproc_patch(B2);
    ...
    parfor p=1:nFore
        ...
        ii = idxFore(p);
        w1 = getwindowmod(ii,Y,wsize);
        w2 = getwindowmod(ii,I,wsize);
        w3 = getwindowmod(ii,Q,wsize);
        %w = [w1(:); w2(:); w3(:)]; 
