...
%   Copyright 2006-2013 The MathWorks, Inc.
     ...
     function over = isOverAxes(evt)
         ...
         % If we are using graphicsversion2, the object that was
         % clicked on is contained in evt.Source. In graphicsversion1,
         % we have to use hittest to determine this information
         % because evt is empty.
