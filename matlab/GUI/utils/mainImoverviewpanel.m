function [hPanel,hImOvLeft] = mainImoverviewpanel(parent,hImLeft)
...
set([hOvLeft],'BorderType','etchedin')

hPanel = uipanel('Parent',parent,'BorderType','none');
hPanelLeft  = uipanel('Parent',hPanel,'Position',[0 0 1 1],'BorderType','none');
...
iptui.internal.setChildColorToMatchParent([hOvLeft,hPanel,hPanelLeft],hFig);
