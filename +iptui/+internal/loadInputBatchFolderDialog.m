function [userCancelled, imageBatchStore] = loadInputBatchFolderDialog()
...
s = Settings;
previousLocations = s.images.imagebatchprocessingtool.BatchLocations;
...
hLoadButton = uicontrol('Parent', loadDirDialog, ...
    ...
    function doLoad(varargin)
        ...
        if(isdir(folderAbsolutePath))
            ...
            imageBatchStore = images.internal.ImageBatchDataStore(...
                folderAbsolutePath,...
                recurseFlag,...
                @pollForCancel);
            ...
            if(imageBatchStore.NumberOfImages==0)
                ...
                s.images.imagebatchprocessingtool.set(...
                    'BatchLocations',{folderAbsolutePath},'user');
            end
            delete(loadDirDialog);
