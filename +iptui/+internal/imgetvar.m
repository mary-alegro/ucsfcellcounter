...
%   Copyright 2004-2014 The MathWorks, Inc.
  ...
  function hPanel = createImportPanel(im_type)
    ...
    if mode==0
        varInd = iptui.internal.filterWorkspaceVars(workspace_vars,im_type);
    elseif mode==1
        varInd = iptui.internal.filterWorkspaceVars(workspace_vars,'colorThresholderRGB');
    elseif mode==2
        varInd = iptui.internal.filterWorkspaceVars(workspace_vars,'imageSegmenterIntensity');
    elseif mode==3
        varInd = iptui.internal.filterWorkspaceVars(workspace_vars,'binary');
    end
