...
alert("Current group: " + getCurrentGroup() + ". Count: "  + getCountsInGroup(getCurrentGroup()).length + "." );// getting the counts for the current selected group
...
function listCountsArr(){
   ...
   desc1.getObjectValue(i).putUnitDouble(charIDToTypeID("X   "),charIDToTypeID("#Px1"),100.000000);
   desc1.getObjectValue(i).putUnitDouble(charIDToTypeID("Y   "),charIDToTypeID("#Px1"),200.000000);
   ...
   for(var i = 0; i<desc1.count; i++){
        ...
        var unitID = desc1.getObjectValue(i).getUnitDoubleType(charIDToTypeID("X   "));
