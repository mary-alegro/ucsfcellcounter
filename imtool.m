...
menuOptionsToDisable = ...
    ...
    'tag','windowlevel menu item','-or',...
    'tag','crop tool menu item','-or',...
    'tag','pixel region menu item','-or',...
    'tag','choose colormap menu item','-or',...
    'tag','adjust contrast menu item');

toolbarButtonsToDisable = ...
    findobj(hFig,...
    'tag','pixel region toolbar button','-or',...
    'tag','adjust contrast toolbar button','-or',...
    'tag','crop tool toolbar button','-or',...
    'tag','windowlevel toolbar button');
